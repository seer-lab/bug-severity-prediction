...
def preprocess(train_data, test_data):
	...
	model_DM = gensim.models.doc2vec.Doc2Vec(vector_size=500, min_count=15, epochs=400, workers=cores,  dm=1, dm_concat=1 )
	model_DBOW = gensim.models.doc2vec.Doc2Vec(vector_size=500, min_count=15, epochs=400, workers=cores, dm=0)
...
class ASP():
	def __init__(self, X_train, Y_train, X_test, Y_test):
		...
		self.classifier = MLPClassifier(solver='sgd', learning_rate='adaptive', learning_rate_init=1, alpha = 0.01, max_iter=10000)
...
# ------------------------------------------------------------------------------
# experiments using SEVERIS parameters and environment
# ------------------------------------------------------------------------------
# datasets
...
for dataset in datasets:
	...
	data = load_data([Dataset(dataset, project_id=1, percent=1, train=False)])
	...
	for train, test in kf.split(data):
		print(' ')
		print('Fold: ', num_fold)
		# create training and testing sets for fold
